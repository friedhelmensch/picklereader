module.exports = [
  {
    inputs: [
      { internalType: "contract IERC20", name: "_pickle", type: "address" },
    ],
  ...
  },
  {
    ...
    name: "poolInfo",
    outputs: [
      { internalType: "uint128", name: "accPicklePerShare", type: "uint128" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_picklePerSecond", type: "uint256" },
    ],
